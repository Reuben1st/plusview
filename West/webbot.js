...
//west2east4
	$.getJSON("https://spreadsheets.google.com/feeds/list/1zrBxgY9x0RfMMd0lGY4pnhI9d2uPh0zk62kkawS19qQ/2/public/values?alt=json-in-script&callback=?",function(result){
			updateUser(result)
	});
//west1east3
	$.getJSON("https://spreadsheets.google.com/feeds/list/1zrBxgY9x0RfMMd0lGY4pnhI9d2uPh0zk62kkawS19qQ/1/public/values?alt=json-in-script&callback=?",function(result){
			updateChat(result)
	});
